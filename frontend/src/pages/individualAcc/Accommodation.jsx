...
return (
    <div className='mx-48 my-16'>
        <Link to='/accommodations'>
            <button
            className='flex flex-row px-3 py-1 rounded-3xl my-8 border-cyan-950 border'>
...
<path id="Vector" d="M0.5 0.5V12.5H1.5V7.5H5.5V9H11.5V2H6.5V0.5H0.5ZM1.5 1.5H5.5V6.5H1.5V1.5ZM6.5 3H10.5V8H6.5V3Z" fill="#0076BF"/>
                    ...
                    <button className='w-full justify-center flex flex-row text-white px-10 py-3 rounded-3xl mt-6 bg-sky-600'>
                        View original PDF
