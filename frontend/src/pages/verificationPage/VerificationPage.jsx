...
<path id="Vector" d="M14.2734 3.21094L6.02344 11.4609L5.50781 12L6.02344 12.5391L14.2734 20.7891L15.3516 19.7109L7.64062 12L15.3516 4.28906L14.2734 3.21094Z" fill="black"/>
    ...
    <div className='mx-10 text-4xl'>
        ...
        <div onClick={handleDelete} className='flex flex-row'>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="trash-alt">
<path id="Vector" d="M11.25 3C10.8574 3 10.4561 3.1377 10.1719 3.42188C9.8877 3.70605 9.75 4.10742 9.75 4.5V5.25H5.25V6.75H6V18.75C6 19.9834 7.0166 21 8.25 21H17.25C18.4834 21 19.5 19.9834 19.5 18.75V6.75H20.25V5.25H15.75V4.5C15.75 4.10742 15.6123 3.70605 15.3281 3.42188C15.0439 3.1377 14.6426 3 14.25 3H11.25ZM11.25 4.5H14.25V5.25H11.25V4.5ZM7.5 6.75H18V18.75C18 19.166 17.666 19.5 17.25 19.5H8.25C7.83398 19.5 7.5 19.166 7.5 18.75V6.75ZM9 9V17.25H10.5V9H9ZM12 9V17.25H13.5V9H12ZM15 9V17.25H16.5V9H15Z" fill="#D90000"/>
    ...
    />
        ...
        <div className='w-1/2 flex flex-col'>
        <div>
        <iframe src="https://rtwblobwsib.blob.core.windows.net/rtwblobs/Accommodations - Construction - Bricklayer (WSIB Newsletter) (1)" width="100%" height="500px"></iframe>
        </div>
...
<g id="angle-left-solid">
<path id="Vector" d="M9.51572 2.14062L4.01572 7.64062L3.67197 8L4.01572 8.35938L9.51572 13.8594L10.2345 13.1406L5.09384 8L10.2345 2.85938L9.51572 2.14062Z" fill="#003359"/>
</g>
</svg>
</div>        
              Back
...
<path id="Vector" d="M0.5 0.5V12.5H1.5V7.5H5.5V9H11.5V2H6.5V0.5H0.5ZM1.5 1.5H5.5V6.5H1.5V1.5ZM6.5 3H10.5V8H6.5V3Z" fill="#0076BF"/>
            ...
            <div className='border p-6 rounded-lg border-neutral-400'>
              ...
              <div>
              Part of Body 
              <p className='rounded-3xl border-green-800 border py-3 px-1 mt-2 mb-6 hover:bg-green-800/25 text-green-800'> {area} </p>
              </div>

              <div>
                Nature of Injury
                <p className='rounded-3xl border-plum border py-3 px-1 mt-2 mb-6 hover:bg-plum/25 text-plum'> {nature} </p>
              </div>
            ...
            <button className='w-full flex flex-row text-white px-10 py-3 rounded-3xl mt-6 bg-sky-600'>
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="external-link-alt-solid">
<path id="Vector" d="M13.5 3.75V5.25H17.6719L8.46094 14.4609L9.53906 15.5391L18.75 6.32812V10.5H20.25V3.75H13.5ZM3.75 6.75V20.25H17.25V10.5L15.75 12V18.75H5.25V8.25H12L13.5 6.75H3.75Z" fill="white"/>
</g>
</svg>
              </div>
            </button>
...
<g id="share-solid">
<path id="Vector" d="M15.2891 3.96094L14.2109 5.03906L18.9219 9.75H8.75C5.8584 9.75 3.5 12.1084 3.5 15C3.5 17.8916 5.8584 20.25 8.75 20.25V18.75C6.66992 18.75 5 17.0801 5 15C5 12.9199 6.66992 11.25 8.75 11.25H18.9219L14.2109 15.9609L15.2891 17.0391L21.2891 11.0391L21.8047 10.5L21.2891 9.96094L15.2891 3.96094Z" fill="#0076BF"/>
</g>
</svg>
