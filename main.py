...
for name, text in zip(data["name"], data["text"]):
    ...
    - Industry Name: Choosing only from the list: {Agriculture, Automotive, Chemical/Process, Construction, Education, Electrical, Food, Forestry, Health Care, Manufacturing, Mining, Municipal, Primary Metals, Pulp & Paper, Services, Transportation} indentify the industry in which the accommodation is used (e.g., Construction);
