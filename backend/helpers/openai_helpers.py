...
def process_with_openai(filename, file_extension, extracted_text):
    ...
    - Accommodation Description: A detailed explanation of the accommodation. Retrieve directly from the text; do not create or alter description;ter names;
    - Injury Location Name: Choosing only from the list: {"Body systems", "Multiple body parts", "Cranial region, including skull", "Leg(s)", "Lower back (lumbar, sacral, coccygeal regions)", "Shoulder", "Ankle(s)", "Finger(s), fingernail(s)", "Arm(s)", "Wrist(s)", "Not Coded", "Foot (feet), except toe(s)", "Chest, including ribs, internal organs", "Pelvic region", "Upper extremities, unspecified, NEC", "Multiple trunk locations", "Multiple lower extremities locations", "Hand(s), except finger(s)", "Upper back (cervical, thoracic regions)", "Multiple back regions", "Abdomen", "Back, unspecified, NEC", "Head, unspecified, NEC", "Eye(s)", "Face", "Toe(s), toenail(s)", "Ear(s)", "Multiple head locations", "Lower extremities, unspecified, NEC", "Trunk, unspecified, NEC", "Other body parts including unclassified, NEC"} identify the part of the body that the accommodation aims to protect or assist. If not found on the list say "Multiple".
    - Industry Name: Choosing only from the list: {"Agriculture, forestry, fishing, and hunting", "Mining, quarrying, and oil and gas extraction", "Utilities", "Construction", "Manufacturing", "Wholesale trade", "Retail trade", "Transportation and warehousing", "Information and cultural industries", "Finance and insurance", "Real estate and rental and leasing", "Professional, scientific, and technical services", "Management of companies and enterprises", "Administrative and support, waste management, and remediation services", "Educational services", "Health care and social assistance", "Arts, entertainment, and recreation", "Accommodation and food services", "Other services (except public administration)", "Public administration"} identify the industry in which the accommodation is used (e.g., Construction). If there is no industry clearly defined or multiple options say "Multiple";
    - Injury Nature Name: Choosing only from the list: {"Sprains and strains", "Psychiatric", "Fractures", "Concussion", "Traumatic injuries, disorders, complications, unspecified, NEC", "Multiple traumatic injuries", "Bruises, contusions", "COVID-19 novel coronavirus", "Intracranial injuries excluding concussions"}. If there is no nature clearly defined as on the list or multiple options say "Multiple".
    - Document Description: please create a summary of the document so that any one who wishes to know what the document is about can get a brief overview. Please take ideas directly from the document only. Begin all summaries with "This document..."

    Ensure the output strictly follows the JSON structure without extra markdown formatting.
    {{
      "accommodations": [
        {{
         "accommodation_name": "",
